...
Write-Host("Tagged and pushed successfully");

Start-Sleep -Seconds 2

$installerUrl = "https://github.com/panoramicdata/LogicMonitor.Provisioning/blob/main/Installer/";
Write-Host("Opening the Github Installer URL: ${installerUrl}");
